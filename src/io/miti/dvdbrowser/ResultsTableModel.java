...
public final class ResultsTableModel extends AbstractTableModel
{
   ...
   */
  private static final String[] columnNames = {"Title", "Year"};
  
  /**
   * The data stored in each row.
   */
  private List<Dvd> rowData = null;
                           ...
                           final int columnIndex)
  {
    ...
    switch (columnIndex)
    {
      ...
      case 1:
        return Dvd.lookupReplacement(dvd.getYear());
   ...
   */
  public void setRowData(final List<Dvd> listData)
  {
